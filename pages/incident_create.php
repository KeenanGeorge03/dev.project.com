										...
										<form role="form" action="incident_logger.php" method="POST">
											...
											<input type="hidden" name="new" value="1">
											  ...
											  <div class="form-group">
											    ...
											    <input type="text" class="form-control" name="cc_recipient" placeholder="CC Recipients" >
											  </div>
											  ...
											  <div class="form-group">
													<label for="body">Description</label>
											  		<textarea name="body" class="form-control" rows="16" placeholder="Describe your incident" ></textarea>
											  </div>
